...
}else{document.location.href="http://"+host;
}},onClickMyTab:function(a){clickcr(a.element,"top.my","","",a.$value());
a.stopDefault();
document.location.href="http://"+host+"/?list=my";
},onClickAllTab:function(a){clickcr(a.element,"top.all","","",a.$value());
a.stopDefault();
document.location.href="http://"+host+"/?list=ct1";
...
if(g.paper){g.paperUrl="http://"+todayNewspaperUrl+g.id;
...
c.stopDefault();
document.location.href="http://"+host+"?list="+b;
},onClickLogin:function(b){clickcr(b.element,"top.login","","",b.$value());
b.stopDefault();
var a=window.open("https://nid.naver.com/nidlogin.login?svctype=64&url=http://"+host+"/login_after.html","","titlebar=1, resizable=0, width=400, height=350");
a.focus();
},onClickLogout:function(a){clickcr(a.element,"top.logout","","",a.$value());
a.stopDefault();
document.location.href="http://nid.naver.com/nidlogin.logout?returl=http%3A%2F%2F"+host+"%2F";
...
}if(a){a.attach("load",function(){if(a.attr("src").indexOf("ad.naver.com")>=0){try{$Element(a.$value().contentWindow.document).attach("mousewheel",c.onPanelMoveEvent);
}catch(f){}}});
...
var c="http://"+host+"/?list="+Newsstand.Header.paramList+"&pcode="+e.id;
if(a=="band"){window.open("http://www.band.us/plugin/share?body="+encodeURIComponent(f)+"%0A"+encodeURIComponent(c),"share_band","width=410, height=400, resizable=no");
return;
...
if(i.paper){i.paperUrl="http://"+todayNewspaperUrl+i.id;
}if(d.paper){d.paperUrl="http://"+todayNewspaperUrl+d.id;
...
if(b.paper){b.paperUrl="http://"+todayNewspaperUrl+b.id;
}if(a.paper){a.paperUrl="http://"+todayNewspaperUrl+a.id;
...
}clickcr(c.element,this.clickPrefix+a,"","",c.$value());
c.stopDefault();
this.moveNext(false);
...
if(m.paper){m.paperUrl="http://"+todayNewspaperUrl+m.id;
}if(c.paper){c.paperUrl="http://"+todayNewspaperUrl+c.id;
}if(h.paper){h.paperUrl="http://"+todayNewspaperUrl+h.id;
...
}},setTodayNewspaper:function(a){$A(a).forEach(function(c,b){if(c.paper&&c.paper!=""){c.paperUrl="http://"+todayNewspaperUrl+c.id;
}else{c.paper="";
}});
